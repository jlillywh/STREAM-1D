...
| `scenarios/simple_channel_ramp_unsteady_linked.json` | Unsteady reach (ramp Q, friction-slope DS) | `projects/simple_channel/` |
| `scenarios/simple_channel_ramp_rating_unsteady_linked.json` | Unsteady reach (ramp Q, rating-curve DS) | `projects/simple_channel/` |
...
# Simple channel ramp transient (Plan 04 friction-slope DS)
