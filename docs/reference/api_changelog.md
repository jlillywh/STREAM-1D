...
JSON/Python input schema version (`api_version` in WASM metadata). Current version: **40**.

| Version | Change |
|---------|--------|
| 40 | Tapered culverts and bridge deck blockage: `culvert_tapered_types`, `culvert_tapered_face_spans`, `culvert_tapered_face_rises`, `culvert_tapered_falls`, `culvert_tapered_crest_weir_lengths`, `culvert_tapered_crest_weir_coeffs`, `culvert_tapered_face_chart_numbers`, `culvert_tapered_face_scale_numbers`, `culvert_tapered_throat_chart_numbers`, `culvert_tapered_throat_scale_numbers` |
| 39 | Left/Right levee support: `levee_left_stations`, `levee_left_elevations`, `levee_right_stations`, `levee_right_elevations` in `SteadyInputs` to enforce overbank flow restrictions below levee elevations |
| 38 | Direct FHWA HDS-5 chart and scale selection for culverts: `culvert_chart_numbers`, `culvert_scale_numbers` in steady/unsteady inputs and metadata |
